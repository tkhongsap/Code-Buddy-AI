...
interface ScoreCodeHeaderProps {
  toggleStreaming: () => void;
  useStreaming: boolean;
}

export default function ScoreCodeHeader({ toggleStreaming, useStreaming }: ScoreCodeHeaderProps) {
  return (
    <>
      {/* Streaming toggle */}
          ...
          <div className="flex items-center">
            <div className="h-10 w-10 rounded-sm bg-primary flex items-center justify-center text-white mr-3 shadow-lg border border-indigo-400/20">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <path d="M21.2 8A10 10 0 0 0 14 2.2"></path>
              </svg>
            </div>
            <div>
